...
SpikingHiddenLayer::SpikingHiddenLayer()
{
}

SpikingHiddenLayer::SpikingHiddenLayer(int aDepth, int aWidth, int aHeight)
{
	createNetwork(aDepth, aWidth, aHeight);
}

void SpikingHiddenLayer::resetNetwork(int aDepth, int aWidth, int aHeight)
{
...
void SpikingHiddenLayer::setInputsAndOutputs(std::vector<position> inputPositions, std::vector<position> outputPositions)
{
...
void SpikingHiddenLayer::setRandomInputsAndOutputs(int numberOfInputs, int numberOfOutputs)
{
...
void SpikingHiddenLayer::setParameters(float aTimeConstant, float aResistance, float aRestingPotential)
{
...
void SpikingHiddenLayer::setSynapses(std::string append, int depth, int width, int height, std::vector<synapse> synapses)
{
	int x, y, z;
...
void SpikingHiddenLayer::setSynapses(int depth, int width, int height, std::vector<synapse> synapses)
{
	int x, y, z;
	for (int n = 0; n < synapses.size(); n++)
	{
...
void SpikingHiddenLayer::setRandomSynapses(int connections, int synapseLength, float minWeight, float maxWeight)
{
	int x, y, z;
...
std::vector<double> SpikingHiddenLayer::activate(std::vector<double> input)
{
...
void SpikingHiddenLayer::activateInputs(std::vector<double> input)
{
...
void SpikingHiddenLayer::activateNeurons(std::string append)
{
...
void SpikingHiddenLayer::activateNeurons()
{
	Neuron* currentNeuron = NULL;
...
void SpikingHiddenLayer::checkActivity()
{
...
std::vector<double> SpikingHiddenLayer::getOutputVector()
{
...
void SpikingHiddenLayer::resetSaveFiles(std::string append)
{
	std::ofstream myfile;
...
void SpikingHiddenLayer::saveInputValues(std::string append)
{
	std::ofstream myfile;
...
void SpikingHiddenLayer::saveInternalValues(std::string append)
{
	std::ofstream myfile;
...
void SpikingHiddenLayer::saveActivity(std::string append)
{
	std::ofstream myfile;
...
void SpikingHiddenLayer::saveSynapse(std::string append, int startDepth, int startWidth, int startHeight, int endDepth, int endWidth, int endHeight, float weight)
{
	std::ofstream myfile;
...
float SpikingHiddenLayer::randomFloat(float a, float b)
{
...
void SpikingHiddenLayer::saveVariables(std::string append)
{
	std::ofstream myfile;
...
void SpikingHiddenLayer::createNetwork(int aDepth, int aWidth, int aHeight)
{
...
void SpikingHiddenLayer::updateBufferSize()
{
	int n = 0;
